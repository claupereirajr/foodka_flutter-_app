                        ...
                        child: Padding(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              boxShadow: const [
                                BoxShadow(color: Colors.black12, blurRadius: 10.0, spreadRadius: 10.0, blurStyle: BlurStyle.normal)
                              ],
                            ),
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Mexican Mamai',
                                  style: TextStyle(color: Colors.grey[900], fontSize: 24.0, fontWeight: FontWeight.bold, letterSpacing: 2.0),
                                ),
                                const SizedBox(height: 10.0,), 
                                Row(
                                  crossAxisAlignment: CrossAxisAlignment.center,
